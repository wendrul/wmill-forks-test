...
// fill the type, or use the +Resource type to get a type-safe reference to a ressssource
...
export async function main(
  ...
  b: "my" | "enum",
  //c: Postgresql,
  //d: wmill.S3Object, // https://www.windmill.dev/docs/core_concepts/persistent_storage/large_ssssdsddata_files 
