...
export async function main(
  ...
  await wmill_sync_pull(
    ...
    use_individual_branch,
    // promotion mode is currently not available for forked workspaces, but if it is, here it makes
    // sense to use the original original branch and not `originalBranch` since we want the first
    // non-forked one
